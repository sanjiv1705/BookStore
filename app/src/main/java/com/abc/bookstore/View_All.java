...
public class View_All extends AppCompatActivity {
    ...
    private void CallApi() {
        ...
        StringRequest request = new StringRequest(Request.Method.POST, "https://www.wanted.today/wanted_demo/all_books_info.php", new Response.Listener<String>() {
            @Override
            public void onResponse(String s) {
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        recycler.setLayoutManager(new LinearLayoutManager(View_All.this));
                        recycler.setAdapter(new Adapter_allBooks(View_All.this, model_allbooks));
                    }
            ...
            public void onErrorResponse(VolleyError volleyError) {
                progressDialog.dismiss();
                Toast.makeText(View_All.this, "" + volleyError, Toast.LENGTH_SHORT).show();
